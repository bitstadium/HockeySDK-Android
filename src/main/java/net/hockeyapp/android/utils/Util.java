...
public class Util {
	...
	public static final String PREFS_NAME_EMAIL = "net.hockeyapp.android.prefs_name_email";
	public static final String PREFS_KEY_NAME_EMAIL = "net.hockeyapp.android.prefs_key_name_email";
